...
INSERT INTO asset_model_stock (id, warehouse_id, model_id, on_hand, reserved, updated_at)
VALUES
    ...
    ('e1000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000001', 25, 0, NOW()),  -- RAM DDR4 8GB:   15+20-2-8=25
    ('e1000000-0000-0000-0000-000000000002', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000002', 18, 0, NOW()),  -- RAM DDR4 16GB:  8+10=18
    ('e1000000-0000-0000-0000-000000000003', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000004', 21, 0, NOW()),  -- SSD NVMe 256GB: 12+15-1-5=21
    ('e1000000-0000-0000-0000-000000000004', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000005',  8, 1, NOW()),  -- SSD NVMe 512GB: 8 (không đổi, reserved=1)
    ('e1000000-0000-0000-0000-000000000005', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000006',  6, 0, NOW()),  -- SSD NVMe 1TB:   6 (không đổi)
    ('e1000000-0000-0000-0000-000000000006', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000007', 12, 0, NOW()),  -- HDD 1TB SATA:   0+12=12 (từ NK-2025)
    ('e1000000-0000-0000-0000-000000000007', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000008',  5, 0, NOW()),  -- HDD 2TB SATA:   5 (không đổi)
    ('e1000000-0000-0000-0000-000000000008', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000009',  7, 0, NOW()),  -- Quạt tản nhiệt: 4+6-3=7
    ('e1000000-0000-0000-0000-000000000009', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000010', 20, 0, NOW()),  -- Nguồn 500W:     20 (không đổi)
    ('e1000000-0000-0000-0000-000000000010', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000011', 18, 0, NOW()),  -- Nguồn 650W:     18 (không đổi)
    ('e1000000-0000-0000-0000-000000000011', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000012', 15, 0, NOW()),  -- Bàn phím USB:   0+25-10=15 (điều chuyển)
    ('e1000000-0000-0000-0000-000000000012', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000013', 15, 0, NOW()),  -- Chuột USB:      0+25-10=15 (điều chuyển)
    ('e1000000-0000-0000-0000-000000000013', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000016', 50, 0, NOW()),  -- Cáp mạng CAT6:  0+50=50
    ('e1000000-0000-0000-0000-000000000014', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000017', 20, 0, NOW()),  -- Cáp HDMI 2m:    0+20=20
    ('e1000000-0000-0000-0000-000000000015', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000020',  4, 0, NOW()),  -- HP Toner CF226A:0+8-2-2=4
    ('e1000000-0000-0000-0000-000000000016', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000021', 16, 0, NOW()),  -- Brother Toner:  10+6=16
    ('e1000000-0000-0000-0000-000000000017', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000022',  8, 0, NOW()),  -- Samsung Toner:  8 (không đổi)
    ('e1000000-0000-0000-0000-000000000018', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000025',  6, 0, NOW()),  -- Pin UPS 12V:    6 (không đổi)
    ('e1000000-0000-0000-0000-000000000019', 'd1000000-0000-0000-0000-000000000001', 'f2000000-0000-0000-0000-000000000027', 15, 0, NOW()),  -- Keo tản nhiệt:  0+20(NK-2025)-5(XK)=15
    ...
    ('e1000000-0000-0000-0000-000000000021', 'd1000000-0000-0000-0000-000000000002', 'f2000000-0000-0000-0000-000000000002',  8, 0, NOW()),  -- RAM DDR4 16GB:  0+8=8
    ('e1000000-0000-0000-0000-000000000022', 'd1000000-0000-0000-0000-000000000002', 'f2000000-0000-0000-0000-000000000003',  4, 0, NOW()),  -- RAM DDR4 32GB:  0+4=4
    ('e1000000-0000-0000-0000-000000000023', 'd1000000-0000-0000-0000-000000000002', 'f2000000-0000-0000-0000-000000000006', 10, 0, NOW()),  -- SSD NVMe 1TB:   4(base)+6(NK-DC)=10
    ('e1000000-0000-0000-0000-000000000024', 'd1000000-0000-0000-0000-000000000002', 'f2000000-0000-0000-0000-000000000008',  4, 0, NOW()),  -- HDD 2TB SATA:   0+4(NK-BASE-DC)=4
    ('e1000000-0000-0000-0000-000000000025', 'd1000000-0000-0000-0000-000000000002', 'f2000000-0000-0000-0000-000000000011',  2, 0, NOW()),  -- Nguồn 650W:     0+2(NK-BASE-DC)=2
    ('e1000000-0000-0000-0000-000000000026', 'd1000000-0000-0000-0000-000000000002', 'f2000000-0000-0000-0000-000000000023',  5, 0, NOW()),  -- SFP Module 1G:  0+5=5
    ('e1000000-0000-0000-0000-000000000027', 'd1000000-0000-0000-0000-000000000002', 'f2000000-0000-0000-0000-000000000024',  4, 0, NOW()),  -- SFP+ Module 10G:0+4=4
    ('e1000000-0000-0000-0000-000000000028', 'd1000000-0000-0000-0000-000000000002', 'f2000000-0000-0000-0000-000000000025',  6, 0, NOW()),  -- Pin UPS 12V:    0+6=6
    ...
    ('e1000000-0000-0000-0000-000000000031', 'd1000000-0000-0000-0000-000000000003', 'f2000000-0000-0000-0000-000000000001',  8, 0, NOW()),  -- RAM DDR4 8GB:   0+8(điều chuyển)=8
    ('e1000000-0000-0000-0000-000000000032', 'd1000000-0000-0000-0000-000000000003', 'f2000000-0000-0000-0000-000000000004',  5, 0, NOW()),  -- SSD NVMe 256GB: 0+5(điều chuyển)=5
    ('e1000000-0000-0000-0000-000000000033', 'd1000000-0000-0000-0000-000000000003', 'f2000000-0000-0000-0000-000000000010',  8, 0, NOW()),  -- Nguồn 500W:     8 (không đổi)
    ('e1000000-0000-0000-0000-000000000034', 'd1000000-0000-0000-0000-000000000003', 'f2000000-0000-0000-0000-000000000012', 10, 0, NOW()),  -- Bàn phím USB:   0+10(điều chuyển)=10
    ('e1000000-0000-0000-0000-000000000035', 'd1000000-0000-0000-0000-000000000003', 'f2000000-0000-0000-0000-000000000013', 10, 0, NOW()),  -- Chuột USB:      0+10(điều chuyển)=10
    ('e1000000-0000-0000-0000-000000000036', 'd1000000-0000-0000-0000-000000000003', 'f2000000-0000-0000-0000-000000000016', 20, 0, NOW()),  -- Cáp mạng CAT6:  0+20(NK-BASE-HN)=20
    ('e1000000-0000-0000-0000-000000000037', 'd1000000-0000-0000-0000-000000000003', 'f2000000-0000-0000-0000-000000000021',  4, 0, NOW()),  -- Brother Toner:  0+4(NK-BASE-HN)=4
    ...
    ('e1000000-0000-0000-0000-000000000041', 'd1000000-0000-0000-0000-000000000004', 'f2000000-0000-0000-0000-000000000001', 10, 1, NOW()),  -- RAM DDR4 8GB:   10(không đổi, res=1)
    ('e1000000-0000-0000-0000-000000000042', 'd1000000-0000-0000-0000-000000000004', 'f2000000-0000-0000-0000-000000000002',  5, 1, NOW()),  -- RAM DDR4 16GB:  5(không đổi, res=1)
    ('e1000000-0000-0000-0000-000000000043', 'd1000000-0000-0000-0000-000000000004', 'f2000000-0000-0000-0000-000000000004',  6, 0, NOW()),  -- SSD NVMe 256GB: 6(không đổi)
    ('e1000000-0000-0000-0000-000000000044', 'd1000000-0000-0000-0000-000000000004', 'f2000000-0000-0000-0000-000000000005',  4, 0, NOW()),  -- SSD NVMe 512GB: 4(không đổi)
    ('e1000000-0000-0000-0000-000000000045', 'd1000000-0000-0000-0000-000000000004', 'f2000000-0000-0000-0000-000000000009',  4, 0, NOW()),  -- Quạt CPU:       0+4(NK-BASE-IT)=4
    ('e1000000-0000-0000-0000-000000000046', 'd1000000-0000-0000-0000-000000000004', 'f2000000-0000-0000-0000-000000000027',  8, 0, NOW()),  -- Keo tản nhiệt:  0+8(NK-BASE-IT)=8
    ('e1000000-0000-0000-0000-000000000047', 'd1000000-0000-0000-0000-000000000004', 'f2000000-0000-0000-0000-000000000029',  3, 0, NOW()),  -- Hub USB-C 7in1: 0+3(NK-BASE-IT)=3
    ('e1000000-0000-0000-0000-000000000048', 'd1000000-0000-0000-0000-000000000004', 'f2000000-0000-0000-0000-000000000032',  5, 0, NOW())   -- Sạc laptop đa năng: 0+5(NK-BASE-IT)=5
