...
-- ============================================================================
-- 2. SPARE PART STOCK (tồn kho linh kiện theo kho)
--    GIÁ TRỊ = kết quả NET của tất cả phiếu kho đã POSTED (tính từ seed-warehouse.sql)
--    Công thức: on_hand = seed-warehouse.base + receipts_posted - issues_posted
--                         - transfers_out_posted + transfers_in_posted ± adjustments_posted
-- ============================================================================

INSERT INTO spare_part_stock (id, warehouse_id, part_id, on_hand, reserved, updated_at)
VALUES
    -- WH-MAIN (d1...001) — Kho chính Trụ sở
    --   Cơ sở từ seed-warehouse.sql + tác động của NK-2025-0001, NK-2026-0001,
    --   XK-2025-0001, XK-2026-0001, DC-2026-0001 (transfer out), DC-KK-2026-0001 (adjust)
    ('e1000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000001', 25, 0, NOW()),  -- RAM DDR4 8GB:   15+20-2-8=25
    ('e1000000-0000-0000-0000-000000000002', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000002', 18, 0, NOW()),  -- RAM DDR4 16GB:  8+10=18
    ('e1000000-0000-0000-0000-000000000003', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000004', 21, 0, NOW()),  -- SSD NVMe 256GB: 12+15-1-5=21
    ('e1000000-0000-0000-0000-000000000004', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000005',  8, 1, NOW()),  -- SSD NVMe 512GB: 8 (không đổi, reserved=1)
    ('e1000000-0000-0000-0000-000000000005', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000006',  6, 0, NOW()),  -- SSD NVMe 1TB:   6 (không đổi)
    ('e1000000-0000-0000-0000-000000000006', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000007', 12, 0, NOW()),  -- HDD 1TB SATA:   0+12=12 (từ NK-2025)
    ('e1000000-0000-0000-0000-000000000007', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000008',  5, 0, NOW()),  -- HDD 2TB SATA:   5 (không đổi)
    ('e1000000-0000-0000-0000-000000000008', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000009',  7, 0, NOW()),  -- Quạt tản nhiệt: 4+6-3=7
    ('e1000000-0000-0000-0000-000000000009', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000010', 20, 0, NOW()),  -- Nguồn 500W:     20 (không đổi)
    ('e1000000-0000-0000-0000-000000000010', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000011', 18, 0, NOW()),  -- Nguồn 650W:     18 (không đổi)
    ('e1000000-0000-0000-0000-000000000011', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000012', 15, 0, NOW()),  -- Bàn phím USB:   0+25-10=15 (điều chuyển)
    ('e1000000-0000-0000-0000-000000000012', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000013', 15, 0, NOW()),  -- Chuột USB:      0+25-10=15 (điều chuyển)
    ('e1000000-0000-0000-0000-000000000013', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000016', 50, 0, NOW()),  -- Cáp mạng CAT6:  0+50=50
    ('e1000000-0000-0000-0000-000000000014', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000017', 20, 0, NOW()),  -- Cáp HDMI 2m:    0+20=20
    ('e1000000-0000-0000-0000-000000000015', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000020',  4, 0, NOW()),  -- HP Toner CF226A:0+8-2-2=4
    ('e1000000-0000-0000-0000-000000000016', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000021', 16, 0, NOW()),  -- Brother Toner:  10+6=16
    ('e1000000-0000-0000-0000-000000000017', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000022',  8, 0, NOW()),  -- Samsung Toner:  8 (không đổi)
    ('e1000000-0000-0000-0000-000000000018', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000025',  6, 0, NOW()),  -- Pin UPS 12V:    6 (không đổi)
    ('e1000000-0000-0000-0000-000000000019', 'd1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000027', 15, 0, NOW()),  -- Keo tản nhiệt:  0+20(NK-2025)-5(XK)=15

    -- WH-DC (d1...002) — Kho Data Center
    --   Cơ sở từ seed-warehouse: c006(SSD1TB)=4
    --   + NK-BASE-DC-2024 (c008, c011) + NK-DC-2026-0001 (c002,c003,c006,c023,c024,c025)
    ('e1000000-0000-0000-0000-000000000021', 'd1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000002',  8, 0, NOW()),  -- RAM DDR4 16GB:  0+8=8
    ('e1000000-0000-0000-0000-000000000022', 'd1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000003',  4, 0, NOW()),  -- RAM DDR4 32GB:  0+4=4
    ('e1000000-0000-0000-0000-000000000023', 'd1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000006', 10, 0, NOW()),  -- SSD NVMe 1TB:   4(base)+6(NK-DC)=10
    ('e1000000-0000-0000-0000-000000000024', 'd1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000008',  4, 0, NOW()),  -- HDD 2TB SATA:   0+4(NK-BASE-DC)=4
    ('e1000000-0000-0000-0000-000000000025', 'd1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000011',  2, 0, NOW()),  -- Nguồn 650W:     0+2(NK-BASE-DC)=2
    ('e1000000-0000-0000-0000-000000000026', 'd1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000023',  5, 0, NOW()),  -- SFP Module 1G:  0+5=5
    ('e1000000-0000-0000-0000-000000000027', 'd1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000024',  4, 0, NOW()),  -- SFP+ Module 10G:0+4=4
    ('e1000000-0000-0000-0000-000000000028', 'd1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000025',  6, 0, NOW()),  -- Pin UPS 12V:    0+6=6

    -- WH-HN (d1...003) — Kho chi nhánh Hà Nội
    --   Cơ sở từ seed-warehouse: c010(PSU500W)=8
    --   + NK-BASE-HN-2024 (c016, c021) + DC-2026-0001 transfer IN (c001,c004,c012,c013)
    ('e1000000-0000-0000-0000-000000000031', 'd1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000001',  8, 0, NOW()),  -- RAM DDR4 8GB:   0+8(điều chuyển)=8
    ('e1000000-0000-0000-0000-000000000032', 'd1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000004',  5, 0, NOW()),  -- SSD NVMe 256GB: 0+5(điều chuyển)=5
    ('e1000000-0000-0000-0000-000000000033', 'd1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000010',  8, 0, NOW()),  -- Nguồn 500W:     8 (không đổi)
    ('e1000000-0000-0000-0000-000000000034', 'd1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000012', 10, 0, NOW()),  -- Bàn phím USB:   0+10(điều chuyển)=10
    ('e1000000-0000-0000-0000-000000000035', 'd1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000013', 10, 0, NOW()),  -- Chuột USB:      0+10(điều chuyển)=10
    ('e1000000-0000-0000-0000-000000000036', 'd1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000016', 20, 0, NOW()),  -- Cáp mạng CAT6:  0+20(NK-BASE-HN)=20
    ('e1000000-0000-0000-0000-000000000037', 'd1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000021',  4, 0, NOW()),  -- Brother Toner:  0+4(NK-BASE-HN)=4

    -- WH-IT (d1...004) — Kho IT phòng CNTT
    --   Cơ sở từ seed-warehouse: c001=10/res=1, c002=5/res=1, c004=6, c005=4
    --   + NK-BASE-IT-2024 (c009, c027, c029, c032)
    ('e1000000-0000-0000-0000-000000000041', 'd1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000001', 10, 1, NOW()),  -- RAM DDR4 8GB:   10(không đổi, res=1)
    ('e1000000-0000-0000-0000-000000000042', 'd1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000002',  5, 1, NOW()),  -- RAM DDR4 16GB:  5(không đổi, res=1)
    ('e1000000-0000-0000-0000-000000000043', 'd1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000004',  6, 0, NOW()),  -- SSD NVMe 256GB: 6(không đổi)
    ('e1000000-0000-0000-0000-000000000044', 'd1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000005',  4, 0, NOW()),  -- SSD NVMe 512GB: 4(không đổi)
    ('e1000000-0000-0000-0000-000000000045', 'd1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000009',  4, 0, NOW()),  -- Quạt CPU:       0+4(NK-BASE-IT)=4
    ('e1000000-0000-0000-0000-000000000046', 'd1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000027',  8, 0, NOW()),  -- Keo tản nhiệt:  0+8(NK-BASE-IT)=8
    ('e1000000-0000-0000-0000-000000000047', 'd1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000029',  3, 0, NOW()),  -- Hub USB-C 7in1: 0+3(NK-BASE-IT)=3
    ('e1000000-0000-0000-0000-000000000048', 'd1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000032',  5, 0, NOW())   -- Sạc laptop đa năng: 0+5(NK-BASE-IT)=5
...
VALUES
    ('f0100000-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000002',
     'c1000000-0000-0000-0000-000000000008', 4, 1250000, 'spare_part', 'HDD SATA 2TB — server storage'),
    ('f0100000-0000-0000-0000-000000000002', 'f0000000-0000-0000-0000-000000000002',
     'c1000000-0000-0000-0000-000000000011', 2, 1750000, 'spare_part', 'Nguồn 650W Corsair RM650x — dự phòng DC')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('f0100000-0000-0000-0000-000000000003', 'f0000000-0000-0000-0000-000000000003',
     'c1000000-0000-0000-0000-000000000016', 20, 32000, 'spare_part', 'Cáp mạng CAT6 3m — hạ tầng HN'),
    ('f0100000-0000-0000-0000-000000000004', 'f0000000-0000-0000-0000-000000000003',
     'c1000000-0000-0000-0000-000000000021',  4, 480000, 'spare_part', 'Brother Toner TN-2480 — máy in HN')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('f0100000-0000-0000-0000-000000000005', 'f0000000-0000-0000-0000-000000000004',
     'c1000000-0000-0000-0000-000000000009', 4, 250000, 'spare_part', 'Quạt tản nhiệt CPU — bảo trì máy tính'),
    ('f0100000-0000-0000-0000-000000000006', 'f0000000-0000-0000-0000-000000000004',
     'c1000000-0000-0000-0000-000000000027', 8,  85000, 'spare_part', 'Keo tản nhiệt Arctic MX-4'),
    ('f0100000-0000-0000-0000-000000000007', 'f0000000-0000-0000-0000-000000000004',
     'c1000000-0000-0000-0000-000000000029', 3, 350000, 'spare_part', 'Hub USB-C 7in1 Ugreen — kỹ thuật viên'),
    ('f0100000-0000-0000-0000-000000000008', 'f0000000-0000-0000-0000-000000000004',
     'c1000000-0000-0000-0000-000000000032', 5, 720000, 'spare_part', 'Sạc laptop đa năng Dell 65W Type-C')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    ('c7000000-0000-0000-0000-000000000002',
     ...
     'in_app', 'sent',
     '{"type":"low_stock","part_id":"c1000000-0000-0000-0000-000000000002","warehouse_id":"d1000000-0000-0000-0000-000000000001","on_hand":10}'::jsonb,
