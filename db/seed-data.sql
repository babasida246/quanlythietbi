...
BEGIN;
    ...
    VALUES
        ('00000000-0000-0000-0000-000000000001', 'admin@example.com', E'Admin H\u1EC7 th\u1ED1ng',    'admin',     '$2b$10$uUd3WfgsTfuV.2rK23paM.v66yLIOKeg5Hrrml4WtO2v/Ep5FEVXu', 'admin',            true, 'active', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000002', 'it.manager@example.com',  E'Nguy\u1EC5n V\u0103n Qu\u1EA3n',   'it_asset_manager', '$2b$10$uUd3WfgsTfuV.2rK23paM.v66yLIOKeg5Hrrml4WtO2v/Ep5FEVXu', 'it_asset_manager', true, 'active', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000003', 'warehouse@example.com',   E'Tr\u1EA7n Th\u1ECB Kho',      'warehouse_keeper', '$2b$10$uUd3WfgsTfuV.2rK23paM.v66yLIOKeg5Hrrml4WtO2v/Ep5FEVXu', 'warehouse_keeper', true, 'active', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000004', 'helpdesk@example.com',    E'L\u00EA Minh H\u1ED7 tr\u1EE3',    'user',      '$2b$10$uUd3WfgsTfuV.2rK23paM.v66yLIOKeg5Hrrml4WtO2v/Ep5FEVXu', 'user',             true, 'active', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000005', 'accountant@example.com',  E'Ph\u1EA1m Thu K\u1EBF to\u00E1n',   'accountant','$2b$10$uUd3WfgsTfuV.2rK23paM.v66yLIOKeg5Hrrml4WtO2v/Ep5FEVXu', 'accountant',       true, 'active', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000006', 'technician@example.com',  E'Ph\u1EA1m \u0110\u1EE9c Minh',      'technician','$2b$10$uUd3WfgsTfuV.2rK23paM.v66yLIOKeg5Hrrml4WtO2v/Ep5FEVXu', 'technician',       true, 'active', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000007', 'requester@example.com',   E'Ho\u00E0ng Th\u1ECB Y\u1EBFn',      'requester', '$2b$10$uUd3WfgsTfuV.2rK23paM.v66yLIOKeg5Hrrml4WtO2v/Ep5FEVXu', 'requester',        true, 'active', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000008', 'viewer@example.com',      E'\u0110\u1EB7ng Qu\u1ED1c Vi\u1EC7t',     'viewer',    '$2b$10$uUd3WfgsTfuV.2rK23paM.v66yLIOKeg5Hrrml4WtO2v/Ep5FEVXu', 'viewer',           true, 'active', NOW(), NOW())
ON CONFLICT
    (email) DO
    UPDATE SET
    ...
    VALUES
        ('c0100000-0000-0000-0000-000000000001', E'\u0110ang s\u1EED d\u1EE5ng',  'in_use',     false, '#22c55e'),
...
ON CONFLICT
    ...
    VALUES
        ('a0000000-0000-0000-0000-000000000001', E'Tr\u1EE5 s\u1EDF ch\u00EDnh',          NULL, '/'),
...
ON CONFLICT
    ...
    VALUES
        ('b0000000-0000-0000-0000-000000000001', 'Dell Technologies', '0100000001', '1800-1111', 'sales@dell.com', E'M\u1EF9'),
...
ON CONFLICT
    ...
    VALUES
        ('b1000000-0000-0000-0000-000000000001', 'SUP-FPT', 'FPT Information System', E'Nguy\u1EC5n Minh Tu\u1EA5n', 'tuan.nm@fpt.com',    '024-7300-0000', E'T\u00F2a nh\u00E0 FPT, C\u1EA7u Gi\u1EA5y, H\u00E0 N\u1ED9i'),
...
ON CONFLICT
    ...
    VALUES
        ('server', E'M\u00E1y ch\u1EE7 v\u1EADt l\u00FD',       E'Server v\u1EADt l\u00FD rack/tower/blade',         NOW()),
...
ON CONFLICT
    ...
    VALUES
        ('runs_on', E'Ch\u1EA1y tr\u00EAn',             E'\u0110\u01B0\u1EE3c host b\u1EDFi',     NOW()),
...
ON CONFLICT
    ...
    INSERT INTO organizations
        (id, name, created_at)
    VALUES
        ('d0000000-0000-0000-0000-000000000001', E'C\u00F4ng ty TNHH C\u00F4ng ngh\u1EC7 ABC',     NOW()),
