...
BEGIN;
    ...
    DELETE FROM asset_model_movements WHERE true;
    DELETE FROM asset_model_stock WHERE true;
...
ON CONFLICT
  ...
  required = EXCLUDED.required, sort_order = EXCLUDED.sort_order;
    ...
    VALUES
        ...
        -- Spare part models (35 mau ma linh kien du phong)
        ('f2000000-0000-0000-0000-000000000001', 'e0000000-0000-0000-0000-000000000021', NULL, NULL,                                  'Kingston',      'KVR32N22S8/8',   '{"speed":"3200MHz","type":"DDR4"}',     10, 'pcs'),
        ('f2000000-0000-0000-0000-000000000002', 'e0000000-0000-0000-0000-000000000021', NULL, NULL,                                  'Kingston',      'KVR32N22D8/16',  '{"speed":"3200MHz","type":"DDR4"}',     5,  'pcs'),
        ('f2000000-0000-0000-0000-000000000003', 'e0000000-0000-0000-0000-000000000021', NULL, NULL,                                  'Kingston',      'KVR32N22D8/32',  '{"speed":"3200MHz","type":"DDR4"}',     3,  'pcs'),
        ('f2000000-0000-0000-0000-000000000004', 'e0000000-0000-0000-0000-000000000022', NULL, 'b0000000-0000-0000-0000-000000000009', 'Samsung',       '980 PRO 256GB',  '{"interface":"NVMe","form":"M.2"}',     10, 'pcs'),
        ('f2000000-0000-0000-0000-000000000005', 'e0000000-0000-0000-0000-000000000022', NULL, 'b0000000-0000-0000-0000-000000000009', 'Samsung',       '980 PRO 512GB',  '{"interface":"NVMe","form":"M.2"}',     8,  'pcs'),
        ('f2000000-0000-0000-0000-000000000006', 'e0000000-0000-0000-0000-000000000022', NULL, 'b0000000-0000-0000-0000-000000000009', 'Samsung',       '980 PRO 1TB',    '{"interface":"NVMe","form":"M.2"}',     5,  'pcs'),
        ('f2000000-0000-0000-0000-000000000007', 'e0000000-0000-0000-0000-000000000022', NULL, NULL,                                  'Seagate',       'Barracuda 1TB',  '{"interface":"SATA","rpm":7200}',       5,  'pcs'),
        ('f2000000-0000-0000-0000-000000000008', 'e0000000-0000-0000-0000-000000000022', NULL, NULL,                                  'Seagate',       'Barracuda 2TB',  '{"interface":"SATA","rpm":7200}',       3,  'pcs'),
        ('f2000000-0000-0000-0000-000000000009', 'e0000000-0000-0000-0000-000000000023', NULL, NULL,                                  'Cooler Master', 'Hyper 212',      '{}',                                    5,  'pcs'),
        ('f2000000-0000-0000-0000-000000000010', 'e0000000-0000-0000-0000-000000000024', NULL, NULL,                                  'Corsair',       'CV550',          '{"watt":550}',                          3,  'pcs'),
        ('f2000000-0000-0000-0000-000000000011', 'e0000000-0000-0000-0000-000000000024', NULL, NULL,                                  'Corsair',       'RM650x',         '{"watt":650}',                          2,  'pcs'),
        ('f2000000-0000-0000-0000-000000000012', 'e0000000-0000-0000-0000-000000000025', NULL, NULL,                                  'Logitech',      'K120',           '{}',                                    20, 'pcs'),
        ('f2000000-0000-0000-0000-000000000013', 'e0000000-0000-0000-0000-000000000025', NULL, NULL,                                  'Logitech',      'M100',           '{}',                                    20, 'pcs'),
        ('f2000000-0000-0000-0000-000000000014', 'e0000000-0000-0000-0000-000000000025', NULL, NULL,                                  'Logitech',      'K270',           '{}',                                    10, 'pcs'),
        ('f2000000-0000-0000-0000-000000000015', 'e0000000-0000-0000-0000-000000000025', NULL, NULL,                                  'Logitech',      'M185',           '{}',                                    10, 'pcs'),
        ('f2000000-0000-0000-0000-000000000016', 'e0000000-0000-0000-0000-000000000026', NULL, NULL,                                  'AMP',           'CAT6-3M',        '{"length":"3m","type":"CAT6"}',          50, 'pcs'),
        ('f2000000-0000-0000-0000-000000000017', 'e0000000-0000-0000-0000-000000000026', NULL, NULL,                                  'Ugreen',        'HDMI-2M',        '{"length":"2m","version":"2.0"}',        20, 'pcs'),
        ('f2000000-0000-0000-0000-000000000018', 'e0000000-0000-0000-0000-000000000026', NULL, NULL,                                  'Ugreen',        'DP-2M',          '{"length":"2m","version":"1.4"}',        10, 'pcs'),
        ('f2000000-0000-0000-0000-000000000019', 'e0000000-0000-0000-0000-000000000026', NULL, NULL,                                  'Anker',         'A8163',          '{"length":"1m","usb":"3.0"}',            15, 'pcs'),
        ('f2000000-0000-0000-0000-000000000020', 'e0000000-0000-0000-0000-000000000027', NULL, 'b0000000-0000-0000-0000-000000000002', 'HP',            'CF226A',         '{}',                                    10, 'pcs'),
        ('f2000000-0000-0000-0000-000000000021', 'e0000000-0000-0000-0000-000000000027', NULL, 'b0000000-0000-0000-0000-000000000010', 'Brother',       'TN-2480',        '{}',                                    10, 'pcs'),
        ('f2000000-0000-0000-0000-000000000022', 'e0000000-0000-0000-0000-000000000027', NULL, 'b0000000-0000-0000-0000-000000000009', 'Samsung',       'MLT-D116L',      '{}',                                    5,  'pcs'),
        ('f2000000-0000-0000-0000-000000000023', 'e0000000-0000-0000-0000-000000000028', NULL, 'b0000000-0000-0000-0000-000000000004', 'Cisco',         'GLC-LH-SM',      '{}',                                    5,  'pcs'),
        ('f2000000-0000-0000-0000-000000000024', 'e0000000-0000-0000-0000-000000000028', NULL, 'b0000000-0000-0000-0000-000000000004', 'Cisco',         'SFP-10G-SR',     '{}',                                    3,  'pcs'),
        ('f2000000-0000-0000-0000-000000000025', 'e0000000-0000-0000-0000-000000000029', NULL, 'b0000000-0000-0000-0000-000000000008', 'APC',           'RBC2',           '{"voltage":"12V","capacity":"7Ah"}',     5,  'pcs'),
        ('f2000000-0000-0000-0000-000000000026', 'e0000000-0000-0000-0000-000000000029', NULL, NULL,                                  'Generic',       'LI-ION',         '{}',                                    3,  'pcs'),
        ('f2000000-0000-0000-0000-000000000027', 'e0000000-0000-0000-0000-000000000023', NULL, NULL,                                  'Arctic',        'MX-4',           '{}',                                    10, 'tube'),
        ('f2000000-0000-0000-0000-000000000028', 'e0000000-0000-0000-0000-000000000030', NULL, NULL,                                  '3M',            'PF240W',         '{"size":"24 inch"}',                    5,  'pcs'),
        ('f2000000-0000-0000-0000-000000000029', 'e0000000-0000-0000-0000-000000000030', NULL, NULL,                                  'Ugreen',        'CM511',          '{}',                                    5,  'pcs'),
        ('f2000000-0000-0000-0000-000000000030', 'e0000000-0000-0000-0000-000000000025', NULL, NULL,                                  'Logitech',      'C920',           '{"resolution":"1080p"}',                 5,  'pcs'),
        ('f2000000-0000-0000-0000-000000000031', 'e0000000-0000-0000-0000-000000000025', NULL, NULL,                                  'Jabra',         'Evolve2 30',     '{}',                                    10, 'pcs'),
        ('f2000000-0000-0000-0000-000000000032', 'e0000000-0000-0000-0000-000000000030', NULL, 'b0000000-0000-0000-0000-000000000001', 'Dell',          '65W Type-C',     '{"watt":65}',                           5,  'pcs'),
        ('f2000000-0000-0000-0000-000000000033', 'e0000000-0000-0000-0000-000000000026', NULL, NULL,                                  'Generic',       'IEC-C13',        '{"length":"1.8m"}',                     20, 'pcs'),
        ('f2000000-0000-0000-0000-000000000034', 'e0000000-0000-0000-0000-000000000023', NULL, NULL,                                  'Noctua',        'NT-H1',          '{}',                                    5,  'tube'),
        ('f2000000-0000-0000-0000-000000000035', 'e0000000-0000-0000-0000-000000000030', NULL, NULL,                                  'Cooler Master', 'Notepal U2',     '{}',                                    3,  'pcs')
    ON CONFLICT
    (id) DO
    UPDATE SET
