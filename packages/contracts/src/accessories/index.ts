...
export type AccessoryStockStatus = 'in_stock' | 'low_stock' | 'out_of_stock';
export type AccessoryCheckoutStatus = 'checked_out' | 'partially_returned' | 'returned';
...
export interface AccessoryWithDetails extends Accessory {
    ...
    stockStatus: AccessoryStockStatus;
}
...
export interface AccessoryCheckout {
    ...
    status: AccessoryCheckoutStatus;
    createdAt: Date;
    updatedAt: Date;
}
...
export interface AccessoryCheckoutListQuery {
    page?: number;
    limit?: number;
    accessoryId?: string;
    assignedUserId?: string;
...
export interface AccessoryPaginatedResult<T> {
    data: T[];
    pagination: {
        page: number;
        limit: number;
...
export interface AccessoryCheckoutSummary {
