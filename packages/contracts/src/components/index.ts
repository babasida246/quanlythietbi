...
export type ComponentReceiptType = 'purchase' | 'restock' | 'transfer' | 'adjustment' | 'initial';
...
export interface ComponentReceipt {
    ...
    quantity: number;
    serialNumbers: string[] | null;
    receiptType: ComponentReceiptType;
    supplierId: string | null;
    purchaseOrder: string | null;
...
// Category DTOs
export interface CreateComponentCategoryDto {
    code: string;
    name: string;
    description?: string | null;
    parentId?: string | null;
...
export interface UpdateComponentCategoryDto {
    name?: string;
    description?: string | null;
    parentId?: string | null;
    isActive?: boolean;
...
// Manufacturer DTOs
export interface CreateComponentManufacturerDto {
    code: string;
    name: string;
    website?: string | null;
    supportUrl?: string | null;
...
export interface UpdateComponentManufacturerDto {
    name?: string;
    website?: string | null;
    supportUrl?: string | null;
    supportPhone?: string | null;
...
export interface ComponentAssignmentListQuery {
    page?: number;
    limit?: number;
    componentId?: string;
    assetId?: string;
...
export interface ComponentReceiptListQuery {
    page?: number;
    limit?: number;
    componentId?: string;
    receiptType?: ComponentReceiptType | ComponentReceiptType[];
    supplierId?: string;
    receivedBy?: string;
    dateFrom?: string;
    dateTo?: string;
...
export interface ComponentCategoryListQuery {
    page?: number;
    limit?: number;
    search?: string;
    parentId?: string | null;
...
export interface ComponentManufacturerListQuery {
    page?: number;
    limit?: number;
    search?: string;
    isActive?: boolean;
...
export interface ComponentPaginatedResponse<T> {
    data: T[];
    pagination: {
        page: number;
        limit: number;
...
export interface ComponentStockAlert {
    id: string;
    componentCode: string;
    name: string;
    componentType: ComponentType;
