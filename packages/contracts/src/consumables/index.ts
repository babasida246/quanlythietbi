...
export type ConsumableIssueType = 'user' | 'department' | 'asset' | 'general';
export type ConsumableReceiptType = 'purchase' | 'return' | 'transfer' | 'adjustment' | 'initial';
export type ConsumableStockStatus = 'in_stock' | 'low_stock' | 'out_of_stock';
...
export interface ConsumableReceipt {
    ...
    consumableId: string;
    quantity: number;
    receiptType: ConsumableReceiptType;
    purchaseOrder: string | null;
...
export interface CreateConsumableCategoryDto {
    code: string;
    name: string;
    description?: string;
    parentId?: string;
...
export interface UpdateConsumableCategoryDto {
    name?: string;
    description?: string | null;
    parentId?: string | null;
    isActive?: boolean;
...
export interface CreateConsumableManufacturerDto {
    code: string;
    name: string;
    website?: string;
    supportUrl?: string;
...
export interface UpdateConsumableManufacturerDto {
    name?: string;
    website?: string | null;
    supportUrl?: string | null;
    supportPhone?: string | null;
...
export interface ConsumableIssueListQuery {
    page?: number;
    limit?: number;
    consumableId?: string;
    issueType?: ConsumableIssueType[];
...
export interface ConsumableReceiptListQuery {
    page?: number;
    limit?: number;
    consumableId?: string;
    receiptType?: ConsumableReceiptType[];
...
export interface ConsumableAuditLogQuery {
    page?: number;
    limit?: number;
    entityType?: string;
    entityId?: string;
...
export interface ConsumablePaginatedResponse<T> {
    data: T[];
    pagination: {
        page: number;
        limit: number;
...
export interface TopConsumer {
    recipientType: ConsumableIssueType;
...
export interface LowStockConsumableItem {
    id: string;
    consumableCode: string;
    name: string;
    quantity: number;
