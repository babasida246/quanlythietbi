 ...
 * Database access layer for accessories (Clean Architecture)
 */
...
export class AccessoryRepo {
    ...
    async list(query: AccessoryListQuery): Promise<AccessoryPaginatedResult<AccessoryWithDetails>> {
    ...
    private mapToAccessoryWithDetails(row: any): AccessoryWithDetails {
        return {
            ...
            stockStatus: row.stock_status as AccessoryStockStatus
        };
    }
