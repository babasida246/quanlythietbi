/**
 * Audit Module - Service Layer (Clean Architecture)
...
export interface IAuditRepository {
    create(dto: CreateAuditDto, client?: PoolClient): Promise<AuditSession>;
    findById(id: string): Promise<AuditSession | null>;
    findByIdWithDetails(id: string): Promise<AuditSessionWithDetails | null>;
    findByCode(code: string): Promise<AuditSession | null>;
    update(id: string, dto: UpdateAuditDto, client?: PoolClient): Promise<AuditSession | null>;
    updateStatus(
        id: string,
        status: AuditStatus,
    ...
    updateTotalItems(id: string, totalItems: number, client?: PoolClient): Promise<void>;
    delete(id: string): Promise<boolean>;
    findAll(query: AuditListQuery): Promise<{ data: AuditSessionWithDetails[]; total: number }>;
    hasActiveAuditForLocation(locationId: string, excludeAuditId?: string): Promise<boolean>;
    findAuditsByAuditor(userId: string): Promise<AuditSessionWithDetails[]>;

    addLocation(auditId: string, locationId: string, client?: PoolClient): Promise<AuditLocation>;
    addLocations(auditId: string, locationIds: string[], client?: PoolClient): Promise<void>;
    findLocationsByAuditId(auditId: string): Promise<AuditLocationWithDetails[]>;
    removeLocation(auditId: string, locationId: string): Promise<boolean>;

    addCategories(auditId: string, categoryIds: string[], client?: PoolClient): Promise<void>;
    findCategoriesByAuditId(auditId: string): Promise<AuditCategoryWithDetails[]>;

    addAuditor(auditId: string, userId: string, locationId?: string, isLead?: boolean, client?: PoolClient): Promise<AuditAuditor>;
    addAuditors(auditId: string, auditors: Array<{ userId: string; locationId?: string; isLead?: boolean }>, client?: PoolClient): Promise<void>;
    findAuditorsByAuditId(auditId: string): Promise<AuditAuditorWithDetails[]>;
    removeAuditor(auditId: string, userId: string): Promise<boolean>;
    isAuditor(auditId: string, userId: string): Promise<boolean>;

    createAuditItem(dto: AuditItemDto, client?: PoolClient): Promise<AuditItem>;
    createAuditItems(auditId: string, assetIds: string[], client?: PoolClient): Promise<number>;
    populateAuditItemsFromScope(auditId: string, locationIds: string[], categoryIds?: string[], client?: PoolClient): Promise<number>;
    findAuditItemById(id: string): Promise<AuditItem | null>;
    findAuditItemByAsset(auditId: string, assetId: string): Promise<AuditItem | null>;
    findAuditItemsByAuditId(auditId: string, query: AuditItemListQuery): Promise<{ data: AuditItemWithDetails[]; total: number }>;
    updateAuditItem(id: string, status: AuditItemStatus, data: Partial<{ actualLocationId: string; actualUserId: string; actualCondition: string; notes: string; auditedBy: string }>, client?: PoolClient): Promise<AuditItem | null>;
    resolveDiscrepancy(id: string, resolutionAction: string, resolvedBy: string, client?: PoolClient): Promise<AuditItem | null>;
    findDiscrepancies(auditId: string, query: DiscrepancyQuery): Promise<{ data: AuditItemWithDetails[]; total: number }>;
    getAuditProgress(auditId: string): Promise<AuditProgress>;

    createUnregisteredAsset(dto: CreateUnregisteredAssetDto, client?: PoolClient): Promise<UnregisteredAsset>;
    findUnregisteredAssetById(id: string): Promise<UnregisteredAsset | null>;
    findUnregisteredAssetsByAuditId(auditId: string, query: UnregisteredAssetQuery): Promise<{ data: UnregisteredAssetWithDetails[]; total: number }>;
    updateUnregisteredAsset(id: string, dto: UpdateUnregisteredAssetDto, client?: PoolClient): Promise<UnregisteredAsset | null>;
    markUnregisteredAssetRegistered(id: string, assetId: string, registeredBy: string, client?: PoolClient): Promise<UnregisteredAsset | null>;

    createHistory(auditId: string, action: string, actorId: string, oldStatus?: AuditStatus, newStatus?: AuditStatus, details?: Record<string, unknown>, client?: PoolClient): Promise<AuditHistory>;
    findHistoryByAuditId(auditId: string): Promise<AuditHistoryWithDetails[]>;

    getStatistics(organizationId?: string): Promise<AuditStatistics>;
...
export class AuditService {
    ...
    async scanAsset(
        ...
        // Look up asset by tag in audit items
