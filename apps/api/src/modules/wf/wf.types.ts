/**
 * Workflow Request & Approval Module - Type Definitions
 */

// Re-export shared enums from @qltb/contracts (single source of truth)
export type {
    WfRequestType,
    WfPriority,
    WfRequestStatus,
...
export interface WfRequestListParams {
    ...
    priority?: WfPriority;
    requesterId?: string;
    assigneeId?: string;     // for inbox: approvals assigned to this user
    page?: number;
    limit?: number;
    search?: string;
}
